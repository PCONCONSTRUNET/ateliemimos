        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-72 max-w-[80vw] bg-card h-full shadow-xl animate-fade-in flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-border">
              ...
              <button onClick={() => setMenuOpen(false)} className="p-2 rounded-full hover:bg-muted transition-colors text-foreground">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-1">
              {/* Todos os Produtos */}
              <button
                onClick={() => { navigate("/"); onSelectCategory(null); setMenuOpen(false); }}
                className="w-full text-left px-4 py-3 rounded-xl text-sm font-semibold text-foreground hover:bg-muted transition-colors"
              >
                🏠 Início
              </button>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-foreground hover:bg-muted transition-colors"
              >
